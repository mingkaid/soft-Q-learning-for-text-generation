...
base_path = "/data/home/ubuntu/classification/soft-Q-learning-for-text-generation/data/yelp-gpt2-words"
...
val = {
    ...
    "shuffle": False,
    "source_dataset": {
        "files": os.path.join(base_path, "dev.source.negative.sep.32"),
        "vocab_file": source_vocab_file,
    },
    "target_dataset": {
        "files": os.path.join(base_path, "dev.target.negative.sep.32"),
        "vocab_file": target_vocab_file,
    }
}
