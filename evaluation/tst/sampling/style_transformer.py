import sys
style_transformer_path = '/workspace/soft-Q-learning-for-text-generation/evaluate_styletransformer/'
...
class StyleTransformerGenerator(BaseGenerator): 
    ...
    def _model_generate(self, task_name, sample_size, top_k=None, top_p=None, **kwargs): 
        ...
        for i, example in tqdm(enumerate(data_iter)):
            input_sentences, output_sentences = generate(example.text.to(self.device),
                                                         ...
                                                         top_k=top_k,
                                                         style=target_style)
            reference_texts = input_sentences
            generated_texts = output_sentences
