import os
import sys
sql_path = '/jupyter/prompt-generation/soft-Q-learning-for-text-generation/'
...
def generate_prompts(task, ckpt_path_short, device_id): 
...
def main(task, ckpt_path_short, device_id, output_path): 
    all_prompts = generate_prompts(task, ckpt_path_short, device_id)
