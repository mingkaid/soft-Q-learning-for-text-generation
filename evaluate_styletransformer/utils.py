...
def top_k_top_p_filtering(logits, top_k=50, top_p=1.0, filter_value=-float('Inf')):
    ...
    if top_k > 0:
        ...
        logits = logits.masked_fill_(logits < threshold, filter_value)   #  (B, vocab_size)
    ...
    if top_p > 0.0:
        ...
        logits = logits.masked_fill_(indices_to_remove, filter_value)
