...
def main(args):
    # logging
    if args.use_wandb:
        wandb.init(project="StyleTransformer", config=args)
        args = wandb.config
        print(args)
    ...
    print('Discriminator:', args.discriminator_method)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-train_iter", help="total training iterations", default=5000 , type=int)
