...
import random
import transformers
from tasks.processors import processors_mapping, num_labels_mapping, output_modes_mapping, compute_metrics_mapping, median_mapping
...
if __name__ == "__main__":
    ...
    def main(config: omegaconf.DictConfig):
        if config.experiment_type == "translation":
            ...
            dataset = FewShotDataset(config.classification, tokenizer=tokenizer, mode="train")
