...
def get_label(task, line):
    if task in ["MNLI", "MRPC", "QNLI", "QQP", "RTE", "SNLI", "SST-2", "STS-B", "WNLI", "CoLA", 'yelp-2', 'agnews', 'dbpedia']:
        # GLUE style
...
def split_header(task, lines):
    ...
    if task in ["CoLA"]:
        return [], lines
    elif task in ["MNLI", "MRPC", "QNLI", "QQP", "RTE", "SNLI", "SST-2", "STS-B", "WNLI", 'yelp-2', 'agnews', 'dbpedia']:
...
def main():
    ...
    parser.add_argument("--task", type=str, nargs="+", 
        default=['SST-2', 'sst-5', 'mr', 'cr', 'mpqa', 'subj', 'trec', 'CoLA', 'MRPC', 'QQP', 'STS-B', 'MNLI', 
                 'SNLI', 'QNLI', 'RTE', 'yelp-2', 'agnews', 'dbpedia', 'yelp-5', 'yahoo', 'amazon-5'],
        help="Task names")
    ...
    parser.add_argument("--mode", type=str, default='k-shot-notruncate', choices=['k-shot', 'k-shot-10x'], help="k-shot or k-shot-10x (10x dev set)") 
